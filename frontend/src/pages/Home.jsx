            ...
            <div className="relative z-10 container mx-auto px-6 py-16 max-w-7xl">
                ...
                >
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.99 }}
                        className="w-full py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-semibold text-lg shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/30 transition-all flex items-center justify-center gap-2"
                    >
                        Join Game Now
                ...
                >
                    ...
                    <div className="space-y-4 mb-8">
                        ...
                        return (
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <IconComponent className="w-5 h-5 text-cyan-400" strokeWidth={2} />
                                </div>
                    ...
                    <div className="border-t border-slate-800 pt-6">
                        <h3 className="text-base font-semibold text-white mb-4">Additional Features:</h3>
                ...
                {!isHost ? (
                    ...
                    <div className="p-10 text-center">
                        ...
                        Create custom quizzes, host live games, and access powerful analytics tools
                        </p>
                        <motion.button
                    ...
                    <div className="p-10 text-center">
                        ...
                        <Trophy className="w-10 h-10 text-emerald-400" strokeWidth={2} />
                ...
                >
                <p className="text-sm">
                    Built for quiz enthusiasts worldwide
                </p>
                </motion.div>
            </div>
            </div>
