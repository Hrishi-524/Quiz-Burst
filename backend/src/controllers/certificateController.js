...
//     try {
//         const { playerName, score, totalQuestions, quizTitle, rank, date } = req.body;
...
//            .fillColor('#64748b')
//            .font('Helvetica')
//            .text(`Completed on ${date || new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}`, 0, currentY, { 
//                width: pageWidth, 
//                align: 'center'
//            });
